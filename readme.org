  ...
  (setq var-pitch-font
   (concat
    ...
    (cond ((eq system-type 'darwin) "13")
      ((eq system-type 'berkeley-unix) "12")
      (t "12")) ;; Fallback
     ))
  ...
  (setq fix-pitch-font
   (concat
    ...
    (cond ((eq system-type 'darwin) "12")
      ((eq system-type 'berkeley-unix) "11")
      (t "11")) ;; Fallback
     ))
...
#+BEGIN_SRC emacs-lisp
  ...
  (cond ((eq system-type 'windows-nt)
	 ...
	 (setenv "DICTDIR" "/usr/local/share/hunspell")  ;; FreeBSD
	 ;; (setenv "DICTDIR" "/usr/local/share/mozilla-dicts")  ;; OpenBSD
	 (setenv "DICTIONARY" "en_GB")  ;; - in OpenBSD, _ in FreeBSD
