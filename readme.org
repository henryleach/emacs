...
#+BEGIN_SRC emacs-lisp
  ...
  (setq var-pitch-fonts '("DejaVu Serif-13" "Georgia-13"))
  (setq fix-pitch-fonts '("Calling Code-12" "DejaVu Sans Mono-11" "Menlo-12" "Courier New-12"))

  (set-face-attribute 'variable-pitch nil :font (apply 'font-candidate var-pitch-fonts))
  (set-face-attribute 'fixed-pitch nil :font (apply 'font-candidate fix-pitch-fonts))

  ;; Default font for most things
  (set-frame-font (apply 'font-candidate fix-pitch-fonts) nil t)
